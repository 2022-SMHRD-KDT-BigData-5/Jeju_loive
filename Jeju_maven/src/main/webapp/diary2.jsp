			...
			<div class="content">
				...
				<div class="grid">
					<figure class="effect-julia">
						<img src="images/1.jpg" alt="img21"/>
						<figcaption>
					...
					<figure class="effect-julia">
						<img src="images/1.jpg" alt="img22"/>
						<figcaption>
							<h2>Passionate <span>Julia</span></h2>
							<div>
								<p>Julia dances in the deep dark</p>
				...
				<div class="grid">
					<figure class="effect-goliath">
						<img src="images/1.jpg" alt="img23"/>
						<figcaption>
					...
					<figure class="effect-goliath">
						<img src="images/1.jpg" alt="img24"/>
						<figcaption>
							<h2>Thoughtful <span>Goliath</span></h2>
							<p>When Goliath comes out, you should run.</p>
							<a href="#">View more</a>
				...
				<div class="grid">
					...
					<figure class="effect-selena">
						<img src="images/1.jpg" alt="img31"/>
						<figcaption>
							<h2>Happy <span>Selena</span></h2>
							<p>Selena is a tiny-winged bird.</p>
							<a href="#">View more</a>
				...
				<div class="grid">
					...
					<figure class="effect-phoebe">
						<img src="images/1.jpg" alt="img07"/>
						<figcaption>
							<h2>Plain <span>Phoebe</span></h2>
							<p>
								<a href="#"><i class="fa fa-fw fa-user"></i></a>
				...
				<div class="grid">
					<figure class="effect-steve">
						<img src="images/1.jpg" alt="img29"/>
						<figcaption>
					...
					<figure class="effect-steve">
						<img src="images/1.jpg" alt="img33"/>
						<figcaption>
							<h2>Lonely <span>Steve</span></h2>
							<p>Steve was afraid of the Boogieman.</p>
							<a href="#">View more</a>
				...
				<div class="grid">
					<figure class="effect-duke">
						<img src="images/1.jpg" alt="img27"/>
						<figcaption>
