...
<body>
		...
		<div id="plan_div">
			...
			<div class="content">
				...
				<form action="PlanInsertCon" method="post">
					여행일을 선택해주세요 >> <input type="date" name="plan_date" id="planInsert"><br />
					<br />
					<div>
	...
	<br>
	<div style="float: right; height: 10%; width: 42%;">
		<input type="button" value="맨위로"
